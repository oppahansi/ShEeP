...
public class Main {
	...
	public static void main(String[] args) {
		...
		menu.setCollision(new Collision(menu.level.getDogList(), menu.level.getSheepList(), menu.level.getPowerUpList(), menu.level.getObstacleList(),menu.level.getCageList(), menu.getWidth(), menu.getHeight(), menu));
