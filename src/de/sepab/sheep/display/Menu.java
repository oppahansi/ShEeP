...
public class Menu{
	...
	public  JButton mainMenuButton_SinglePlayer = new JButton("Einzelspieler"), //mm = mainmenu & b=button
						  ...
						  highscoreButton_Back = new JButton("Zur�ck"), //hs = highscore
						  	...
						  	creditsButton_Back = new JButton("Zur�ck"),
						  	
						  gameBoard_MultiplayerBack = new JButton("Zur�ck"),
							gameBoard_SingleplayerBack = new JButton("Zur�ck"),
	...
	public  String[] 	   singlePlayerSelection_Map = {"Karte1","Karte2","Karte3"},
						   ...
						   modusTooltip = {"In diesem Modus versucht der Spieler soviele Schafe wie m�glich in einer gewissen Zeit einzufangen \r\n", 
											 "In diesem Modus versucht der Spieler so schnell wie m�glich eine gewisse Anzahl an schafen einzufangen \r\n"};
	...
	public void run() {
		...
		
		{
			 helpLabel_imageSpeed.setToolTipText("Schnelligkeit: Verdoppelt die Geschwindigkeit des Benutzers.");
	  		 ...
	  		 helpLabel_imageDeaf.setToolTipText("Taubheit(nur Schaf): Gew�hrt Immunit�t gegen bellen.");
	  		 helpLabel_imageSuperBark.setToolTipText("Super bellen(nur Hund). gew�hrt eine erh�hte Reichweite des bellens.");
	  		 helpLabel_imageTeleport.setToolTipText("Teleportation:(bei Hund) Teleportiert ein zuf�lliges Schaf ins Gehege. (bei Schaf) Teleportiert ein Schaf aus dem Gehege.");
